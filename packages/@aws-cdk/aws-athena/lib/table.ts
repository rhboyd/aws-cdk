...
/**
 * TODO add extends [the right base class]
 */
...
export class Table extends Construct implements ITable {
    ...
    new AwsCustomResource(this, 'VerifyDomainIdentity', {
        onCreate: {
            service: 'Athena',
            action: 'startQueryExecution',
            parameters: {
                QueryString: `CREATE EXTERNAL TABLE IF NOT EXISTS ${props.databaseName}.${props.tableName} (Date DATE, Time STRING, Location STRING) LOCATION 's3://${props.queryBucket.bucketName}'/`,
